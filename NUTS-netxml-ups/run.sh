...
STREAMING_CHUNK: Leyendo las variables de configuración de Home Assistant...
...
STREAMING_CHUNK: Escribiendo los archivos de configuración para NUT...
...
STREAMING_CHUNK: Iniciando los demonios de NUT en orden...
